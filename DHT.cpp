...
/**
 * (30.9.22) 
 * Added by t3ch aka B.K. aka grandekos aka etc... 
 * so pin and type can be configured after contoller already running.
 * */
...
/***/
void DHT::setPinNType(uint8_t pin, uint8_t type) {
    _pin  = pin;
    _type = type;
#ifdef __AVR
  _bit = digitalPinToBitMask(pin);
